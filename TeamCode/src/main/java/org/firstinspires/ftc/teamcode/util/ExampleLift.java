...
public class ExampleLift implements Subsystem {
    ...
    public Command toLowBasket = new RunToPosition(controlSystem, 500).requires(this);

    public Command toMidChamber = new RunToPosition(controlSystem, 1200).requires(this);
