...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        ...
        public double parYTicks = -10792.233539532279; // y position of the parallel encoder (in tick units) //todo
        public double perpXTicks = -15091.369561547215; // x position of the perpendicular encoder (in tick units) //todo
