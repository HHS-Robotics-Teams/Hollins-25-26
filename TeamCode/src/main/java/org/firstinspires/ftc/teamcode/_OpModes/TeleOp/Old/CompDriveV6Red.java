...
import static org.firstinspires.ftc.teamcode._Util.OLD.HoodUtilV2.HoodState.*;
...
@Disabled
@Deprecated
public class CompDriveV6Red extends OpMode {
    ...
    public void init() {
        ...
        launcherUtil = new LauncherUtilV4Limelight("RED", false, new LightUtil(2, hardwareMap),hardwareMap);
        /* ---------- Telemetry ---------- */
    ...
    public void loop() {
        ...
        if(input.a_cross.down()){
            launcherUtil.overwriteHoodState(Far);
        }
