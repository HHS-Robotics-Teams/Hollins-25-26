...
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.DRIVE_TO_INTAKE_ONE;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.DRIVE_TO_INTAKE_TWO;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.DRIVE_TO_LAUNCH_THREE;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.DRIVE_TO_LAUNCH_TWO;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.END;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.INTAKE_TWO;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.LAUNCH_ONE;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.LAUNCH_THREE;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.LAUNCH_TWO;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.PARK;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.RESET_ONE;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.RESET_THREE;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.RESET_TWO;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.SPIN_UP;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.SPIN_UP_THREE;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.SPIN_UP_TWO;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.Red.RedVeryFarSpikeMark.AutoState.START;
...
public class RedFarNoSpike extends OpMode {
    ...
    public void init() {
        ...
        turnToLaunch = drive.actionBuilder(new Pose2d(72 - (16.25/2), (13 / 2) + 24, Math.toRadians(180)))
                .waitSeconds(3)
                .strafeToLinearHeading(new Vector2d(50, 13), Math.toRadians(151))
                .build();
        driveToIntakeOne = drive.actionBuilder(new Pose2d(50, 13, Math.toRadians(152)))
                .afterDisp(20, () -> intakeUtil.intakeOn())
                .strafeToLinearHeading(new Vector2d(60,54),Math.toRadians(90))
                .waitSeconds(0.1)
                .strafeToConstantHeading(new Vector2d(65,54))
                .strafeToLinearHeading(new Vector2d(68,60),Math.toRadians(60))
                .strafeToLinearHeading(new Vector2d(50, 12), Math.toRadians(153))
                .afterDisp(5, () -> intakeUtil.intakeOff())
                .build();
        driveToIntakeTwo = drive.actionBuilder(new Pose2d(50, 12, Math.toRadians(153)))
                .afterDisp(20, () -> intakeUtil.intakeOn())
                .strafeToLinearHeading(new Vector2d(60,54),Math.toRadians(90))
                .waitSeconds(0.1)
                .strafeToConstantHeading(new Vector2d(65,54))
    ...
    public void start(){
        ...
        LauncherMotor.setVelocity(LAUNCH_TICK_VELOCITY_FAR + 425);
       ...
       // telemetry.addData("State:", state);
        ...
        switch (state){
            ...
            case SPIN_UP:
                ...
                break;
            case LAUNCH_ONE:
                if (LauncherMotor.getVelocity() >= LAUNCH_TICK_VELOCITY_FAR + 425){ // do not change this time
                ...
                break;
            case RESET_ONE:
                if (launchTimer.seconds() >= (Launch_Time + .5) || autoUtil.isBotEmpty() ) { // todo change Time
            ...
            case DRIVE_TO_INTAKE_ONE:
                ...
                LauncherMotor.setVelocity(LAUNCH_TICK_VELOCITY_FAR + 405);
                break;
            ...
            case SPIN_UP_TWO:
                ...
                break;
            case LAUNCH_TWO:
                if(LauncherMotor.getVelocity() >= LAUNCH_TICK_VELOCITY_FAR + 405){
            ...
            case INTAKE_TWO:
                ...
                LauncherMotor.setVelocity(LAUNCH_TICK_VELOCITY_FAR + 410);
                break;
            ...
            case SPIN_UP_THREE:
                ...
                break;
            case LAUNCH_THREE:
                if (LauncherMotor.getVelocity() >= LAUNCH_TICK_VELOCITY_FAR + 410) { // todo change Time
