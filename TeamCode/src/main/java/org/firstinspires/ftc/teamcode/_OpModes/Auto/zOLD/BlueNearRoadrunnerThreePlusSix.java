...
import static org.firstinspires.ftc.teamcode._OpModes.Auto.zOLD.BlueNearRoadrunnerThreePlusSix.AutoState.RESET_ONE;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.zOLD.PathFactory.blueFarLaunchPose;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.zOLD.PathFactory.blueNearLaunchPose;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.zOLD.PathFactory.bluePGPPickupStartPose;
import static org.firstinspires.ftc.teamcode._OpModes.Auto.zOLD.PathFactory.bluePPGPickupStartPose;
    ...
    public void loop() {
        ...
        switch (state){
            ...
            case SPIN_UP:
                ...
                if(LauncherMotor.getVelocity() >= 700) /*&& intakeTimer.seconds() >= .5)*/ {  // do not change this time
            ...
            case LAUNCH_ONE:
                ...
                break;
            case RESET_ONE:
                if ((LauncherMotor.getVelocity() >= 700) && ( intakeTimer.seconds() >= 0.5)){
                    LauncherFingerServo.setPosition(LAUNCHER_FINGER_UP_POS);
                    IntakeMotor.setPower(0);
                    LeftSideFeedRoller.setPower(1);
            ...
            case RESET_TWO: // Todo Find better solution to not feeding 3rd ball probable mechanical
                if ((LauncherMotor.getVelocity() >= 750) && (intakeTimer.seconds() >= 1.0)) {
                    LauncherFingerServo.setPosition(LAUNCHER_FINGER_UP_POS);
                    LeftSideFeedRoller.setPower(1);
            ...
            case SPIN_UP_TWO:
                ...
                LauncherSafetyServo.setPosition(SAFTEY_FIRING);
                LauncherMotor.setPower(.3);
                if((LauncherMotor.getVelocity() >= 750) && (intakeTimer.seconds() >= 0.5)){
                    LauncherFingerServo.setPosition(LAUNCHER_FINGER_UP_POS);
                    LeftSideFeedRoller.setPower(1);
