...
public final class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.00031504564470477607;
        public double trackWidthTicks =  25426.249696782634; //todo

        // feedforward parameters (in tick units)
        public double kS = 1.1630082156834307;
        public double kV = 0.000060210024088786034;
        public double kA = 0.00002;

        // path profile parameters (in inches)
        public double maxWheelVel = 170;
        public double minProfileAccel = -170;
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            if (t >= timeTrajectory.duration && error.heading.toDouble() <= 2 && error.position.norm() < 1 && robotVelRobot.linearVel.norm() < 0.25) {
