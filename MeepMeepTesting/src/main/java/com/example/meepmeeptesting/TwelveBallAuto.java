...
public class TwelveBallAuto {
    public static void main(String[] args){
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .setConstraints(150, 150, 1.5 * Math.toRadians(180), 1.5 * Math.toRadians(180), 14 )
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(startPos)
                ...
                .waitSeconds(3.5)
                //Intake 1st Spike
                //.splineToLinearHeading(new Pose2d(-12.5,24,Math.toRadians(89)),Math.toRadians(89))
                ...
                // Intake 2nd spike
                .strafeToLinearHeading(new Vector2d(12,28),Math.toRadians(90))
                .strafeToConstantHeading(new Vector2d(12, 65),new TranslationalVelConstraint(50))
                .waitSeconds(.3)
                .lineToYConstantHeading(50)
                //.strafeToConstantHeading(new Vector2d(2,58))
                .strafeToLinearHeading(new Vector2d(-24,24),Math.toRadians(135))
                //.splineToLinearHeading(new Pose2d(-24,24,Math.toRadians(130)),Math.toRadians(90))
                .waitSeconds(3)
                // Intake 3rd spike
                .strafeToLinearHeading(new Vector2d(36, 28), Math.toRadians(90))
                .strafeToConstantHeading(new Vector2d(36, 65), new TranslationalVelConstraint(50))
                .waitSeconds(.3)
                .lineToYConstantHeading(58)
                //.splineToLinearHeading(new Pose2d(-36,24, Math.toRadians(120)),Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(-36, 26), Math.toRadians(135))
